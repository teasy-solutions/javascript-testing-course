...
var q = (n, r, t) => r in n ? E(n, r, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[r] = t;
var A = (n, r) => {
  for (var t in r)
  ...
  if (r && typeof r == "object" || typeof r == "function")
    for (let e of H(r))
      !S.call(n, e) && e !== t && E(n, e, { get: () => r[e], enumerable: !(s = I(r, e)) || s.enumerable });
  return n;
};
var z = (n) => j(E({}, "__esModule", { value: !0 }), n);
var a = (n, r, t) => (q(n, typeof r != "symbol" ? r + "" : r, t), t);
...
var c = class extends EventTarget {
  ...
  async run() {
    ...
    for (await this.bench.setup(this, "run"); (s < this.bench.time || this.runs < this.bench.iterations) && !((h = this.bench.signal) != null && h.aborted); ) {
      ...
      let u = this.bench.now() - o;
      this.runs += 1, e.push(u), s = this.bench.now() - t;
    }
    await this.bench.teardown(this, "run"), e.sort();
    {
      let o = e[0], u = e[e.length - 1], v = s / this.runs, K = 1 / v, w = B(e), T = L(e, w), k = Math.sqrt(T), g = k / Math.sqrt(e.length), y = e.length - 1, x = b[String(Math.round(y) || 1)] || b.infinity, M = g * x, R = M / w * 100 || 0, _ = e[Math.ceil(e.length * (75 / 100)) - 1], O = e[Math.ceil(e.length * (99 / 100)) - 1], F = e[Math.ceil(e.length * (99.5 / 100)) - 1], P = e[Math.ceil(e.length * (99.9 / 100)) - 1];
...
var p = class extends EventTarget {
  constructor(t = {}) {
    ...
    a(this, "setup");
    a(this, "teardown");
    this.now = (s = t.now) != null ? s : this.now, this.warmupTime = (e = t.warmupTime) != null ? e : this.warmupTime, this.warmupIterations = (h = t.warmupIterations) != null ? h : this.warmupIterations, this.time = (l = t.time) != null ? l : this.time, this.iterations = (m = t.iterations) != null ? m : this.iterations, this.signal = t.signal, this.setup = (o = t.setup) != null ? o : () => {
